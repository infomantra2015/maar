...
class Message{
    ...
    const STORE_ID_IS_REQUIRED          = 'Store Id is required.';
    ...
    const DELETE_STORE_PICTURE_SUCCESS  = 'Your store picture deleted successfully.';
    const REMOVE_STORE_LOGO_SUCCESS     = 'Your store logo removed successfully.';
    const SET_STORE_LOGO_SUCCESS        = 'Your store logo set successfully.';
}